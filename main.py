...
#     landing_details, takeoff_details = detect_landing_takeoff_with_details(df, 100, 10, 5)
#     return {"landing_details": landing_details}
...
async def create_upload_file(file: UploadFile):
    df = pd.read_csv(file.file)
    _, takeoff_details = detect_landing_takeoff_with_details(df, 50, 10, 5)
